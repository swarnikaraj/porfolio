...
const Profile = () => {
  return (
    <div className="flex h-full overflow-y-auto lg:w-1/3 w-full mid:w-1/3 flex-col items-center px-2 border-blue-800 border-l border-t border-b">
      <p className="py-2 text-2xl uppercase font-bold text-blue-800">Profile</p>
      <div className="relative">
        <Image
          ...
          alt="Profile Picture"
          className="rounded-full shadow-lg border-4 border-blue-800 hover:shadow-md"
          width={250}
          height={250}
        />
      </div>
      <div className="text-blue-800 font-bold text-lg">Hello!</div>
      <p className="font-mono py-1 text-xl">
        <span>I&apos;m</span>{" "}
        <span className="text-blue-800 font-bold">Swarnnika</span>{" "}
        <span className="text-blue-800 font-bold">Raj</span>{" "}
        <span className="text-blue-800 font-bold">Singh</span>
      </p>
      <p className="font-mono py-2 text-lg text-blue-800">
        Fullstack Developer
      </p>
